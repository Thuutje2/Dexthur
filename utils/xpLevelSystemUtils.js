...
async function handleXP(userId, guildId, cooldownTime = 60000) { // 1 minute
    try {
        ...
        const now = Date.now();
        const lastMessageTime = userData.lastMessageTimestamp ? userData.lastMessageTimestamp.getTime() : 0;
