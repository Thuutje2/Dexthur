module.exports = [
  ...
  { id: 'dbdLevel1', name: 'Trial Rookie', description: 'Reach level 1 and become a Trial Rookie!', rarity: 50, emoji: '🏅' },
  { id: 'dbdLevel2', name: 'Perk Pupil', description: 'Reach level 2 and become a Perk Pupil!', rarity: 75, emoji: '🏅' },
  { id: 'dbdLevel3', name: 'Skill Check Survivor', description: 'Reach level 3 and become a Skill Check Survivor!', rarity: 100, emoji: '🏅' },
  { id: 'dbdLevel4', name: 'Chase Champion', description: 'Reach level 4 and become a Chase Champion!', rarity: 150, emoji: '🌟' },
  { id: 'dbdLevel5', name: 'Hook Dodger', description: 'Reach level 5 and become a Hook Dodger!', rarity: 200, emoji: '🌟' },
  { id: 'dbdLevel6', name: 'Totem Tracker', description: 'Reach level 6 and become a Totem Tracker!', rarity: 300, emoji: '🌟' },
  { id: 'dbdLevel7', name: 'Escape Artist', description: 'Reach level 7 and become an Escape Artist!', rarity: 500, emoji: '💎' },
  { id: 'dbdLevel8', name: 'Fog Wanderer', description: 'Reach level 8 and become a Fog Wanderer!', rarity: 750, emoji: '💎' },
