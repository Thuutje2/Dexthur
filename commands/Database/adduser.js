...
//         await db.query('INSERT INTO users (user_id, username, discriminator, balance, last_daily_claim, last_monthly_claim, last_yearly_claim) VALUES ($1, $2, $3, $4, $5, $6, $7)',
//           [message.author.id, message.author.username, message.author.discriminator, 0, currentTime, currentTime, currentTime]);
