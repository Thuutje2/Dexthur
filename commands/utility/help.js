    ...
    const pages = [
      {
        ...
        commands: [
            ...
            { name: '`Page 6`', value: '👑 Disney Guess Game Commands'},
            { name: '`Page 7`', value: '🎮 Video Games Information Commands' },
        ]
      },
      {
      ...
      },
      {
        ...
        commands: [
          ...
          { name: 'DisneyCharacters', value: 'Get a list of Disney characters. `!DisneyCharacters or !dc`' },
