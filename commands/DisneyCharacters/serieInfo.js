...
module.exports = {
    ...
    async execute(message, args) {
        try {
            ...
            const res = await query('SELECT * FROM disney_characters WHERE LOWER(series_film) = $1', [serie]);

            if (res.rows.length === 0) {
                return message.reply(`No characters found for series or movie: ${serie}`);
            }
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`**Total characters:** ${serieCharacters.length} \n\n`
